 ...
 * @date: 2020/10/5 0005 17:53
 **/
public abstract class BaseBullet {
    protected static final int SPEED = PropMgr.getIntProp("bullet.speed");
    protected int x;
    protected int y;
    ...
    public BaseBullet(int x, int y, Dir dir, TankFrame tankFrame,Tank tank, Group group) {
        this.dir = dir;
